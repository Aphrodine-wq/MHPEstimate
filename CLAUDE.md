...
**Tables**: `estimates`, `estimate_line_items`, `clients`, `products`, `unified_pricing`, `invoices`, `voice_calls`, `team_members`, `company_settings`, `job_actuals`, `estimate_change_orders`. Migrations are in `supabase/migrations/`.
