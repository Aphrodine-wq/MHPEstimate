  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto">
      <header className="px-8 pt-6 pb-1">
        <h1 className="text-[24px] font-bold tracking-tight">Call History</h1>
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-[var(--sep)] bg-[var(--card)]">
            {calls.map((call, i, arr) => (
              <div key={call.id} className={`flex items-center gap-3 px-4 py-3.5 hover:bg-[var(--bg)] ${i < arr.length - 1 ? "border-b border-[var(--sep)]" : ""}`}>
