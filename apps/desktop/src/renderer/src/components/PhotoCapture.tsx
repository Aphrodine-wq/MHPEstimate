    ...
    return (
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="relative">
          <button type="button" onClick={() => inputRef.current?.click()} disabled={disabled || atLimit} title={atLimit ? `Maximum ${maxPhotos} photos reached` : "Add site photo"} className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--accent)]/10 text-[var(--accent)] transition-all hover:bg-[var(--accent)]/20 active:scale-90 disabled:cursor-not-allowed disabled:opacity-40">
            <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="var(--accent)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
