        ...
        {steps.map((s, i) => (
          <div key={i} className="flex flex-col items-center gap-1.5 flex-1">
            <div
              ...
              style={{ background: `color-mix(in srgb, ${i === 0 ? "var(--accent)" : i === 1 ? "var(--accent)" : i === 2 ? "var(--purple)" : "var(--green)"} 12%, transparent)` }}
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke={i === 0 ? "var(--accent)" : i === 1 ? "var(--accent)" : i === 2 ? "var(--purple)" : "var(--green)"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d={s.icon} />
              </svg>
            </div>
